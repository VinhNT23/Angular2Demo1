...
var PersonDetailsComponent = (function () {
    function PersonDetailsComponent(peopleService, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.professions = ['test1', 'test2', 'test3', 'test4'];
    }
    PersonDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.params.subscribe(function (params) {
            var id = Number.parseInt(params['id']);
            _this.peopleService.get(id).subscribe(function (p) { return _this.person = p; });
        });
    };
    ...
    PersonDetailsComponent.prototype.savePersonDetails = function () {
        this.peopleService.save(this.person).subscribe(function (r) { return (alert('Success')); });
